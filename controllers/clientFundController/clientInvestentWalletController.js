...
//     {
//       $match: {
//         "doc.transactionType": "WITHDRAWAL",
//       },
//     },
//     {
...
//     },
//   ];
//   if (transactionType !== "ALL" && !filterTAccountNo) {
...
//       options.paymentStatus = "DEPOSIT";
//       options.transactionType = "DEPOSIT";
//     } else if (transactionType?.toLowerCase() === "transfer") {
//       options.paymentStatus = "INTERNAL_TRANSFER";
//       options.transactionType = "DEPOSIT";
//     } else if (transactionType?.toLowerCase() === "trtotrtransfer") {
//       options.paymentStatus = "INTERNAL_TRANSFER";
//       options.transactionType = "DEPOSIT";
//       options.accountType = "TRADING";
//       options["fromAccount.type"] = "TRADING";
//       options["toAccount.type"] = "TRADING";
//     } else if (transactionType?.toLowerCase() === "withdrawal") {
//       // console.log("here");
//       options.paymentStatus = "WITHDRAWAL";
//       options.transactionType = "WITHDRAWAL";
//     } else if (transactionType?.toLowerCase() === "credit") {
//       options.paymentStatus = {
//         $in: ["CREDITIN", "CREDITOUT"],
//       };
//       options.transactionType = "CREDIT";
//     } else if (transactionType?.toLowerCase() === "bonus") {
//       options.paymentStatus = {
//         $in: ["BONUSIN", "BONUSOUT"],
//       };
//       options.transactionType = "BONUS";
//     } else if (transactionType?.toLowerCase() === "correction") {
//       options.paymentStatus = {
//         $in: ["CORRECTIONIN", "CORRECTIONOUT"],
//       };
//       options.transactionType = "CORRECTION";
//     } else if (transactionType?.toLowerCase() === "charge") {
//       options.paymentStatus = {
//         $in: ["CHARGEIN", "CHARGEOUT"],
//       };
//       options.transactionType = "CHARGE";
//     } else if (transactionType?.toLowerCase() === "directdeposits") {
//       options.paymentStatus = {
//         $in: ["DEPOSITIN", "WITHDRAWALOUT"],
//       };
//       options.transactionType = "BALANCE";
//     }
//   }
//   if (filterTAccountNo && filterTAccountNo !== "ALL") {
//     (options.accountType = "TRADING"),
//       // (options.transactionType = "CREDIT"),
//       (options.$or = [
//         // { "fromAccount.id": filterTAccountNo },
//         { "toAccount.id": filterTAccountNo },
//       ]);
//   }
...
//   const result =
//     await clientAccountTransactionHistoryRepository.getTransByOptions(
//       options,
//       "-_id -updatedAt",
//       { createdAt: -1 },
//       skip,
...
//   // console.log(result);
//   const countRecords =
//     await clientAccountTransactionHistoryRepository.countTransactions(options);
//   const getWithdrawRequest =
//     await withdrawlRequestsRepository.getWithdrawRequestByWhiteLabel(
//       userMId,
//       whiteLabel
//     );
//   // console.log(getWithdrawRequest);
...
//     {}
//   );
//   // console.log(withdrawalPaymentMeathodDict);
...
//           // externalReferenceId: transaction.externalReferenceId || null,
//         },
//         financials: {
...
// export const getTransactionHistory2 = asyncHandler(async (req, res) => {
//   let { id, whiteLabel } = req.user;
//   let {
//     fromDate,
//     toDate,
