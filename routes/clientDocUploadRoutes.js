...
import {
  uploadDocFiles,
  getClientDocFilesDownload,
  updateClientDocStatus,
  removeUploadedFileDoc,
  interRemoveDocs,
...
import { validateUploadDocFiles } from "../validations/clientDocValidation.js";
...
router.post("/uploadDoc",handleUpload,(req, res, next) => {next()},authHandler,uploadDocFiles);
router.post("/getClientDoc", authHandler, getClientDocFilesDownload);
router.post("/updateInfo", updateClientDocStatus);
router.post("/removeDoc", removeUploadedFileDoc);
router.post("/removeInterDoc", authHandler, interRemoveDocs);
